# split_by_item { #billsplittermds.split_by_item }
...
| Name | Description |
| --- | --- |
| [split_by_item](#billsplittermds.split_by_item.split_by_item) | Calculates a derived column called individual_price, which is the amount |

### split_by_item { #billsplittermds.split_by_item.split_by_item }

```python
split_by_item.split_by_item(valid_df)
```
...
|----------|------------------|---------------------------------------------------------------------------------------------------------------------------|------------|
| valid_df | pandas.DataFrame | A dataframe after being validated with columns 'payer', 'item_name', 'item_price', 'shared_by', 'tax_pct', and 'tip_pct'. | _required_ |

#### Returns {.doc-section .doc-section-returns}

| Name          | Type             | Description                                           |
|---------------|------------------|-------------------------------------------------------|
| should_pay_df | pandas.DataFrame | Dataframe with columns 'individual' and 'should_pay'. |
